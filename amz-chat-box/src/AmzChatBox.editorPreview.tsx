import { AmzChatBoxPreviewProps } from '../typings/AmzChatBoxProps'

export function preview(_props: AmzChatBoxPreviewProps) {
  return (
    <div className='amz-chat-box-preview'>
      <div className='amz-web-wrapper'>
        <div className='amz-chat-box'>
          <div className='amz-chat-box-icon'>
            <svg xmlns='http://www.w3.org/2000/svg' height='48px' viewBox='0 -960 960 960' width='48px' fill='#37474f'>
          ...
          <div className='amz-chat-box-text'>AI Assistant Bot</div>
        </div>
      </div>
    </div>
  )
...
export function getPreviewCss(): string {
  return require('./styles/AmzChatBoxPreview.scss')
}
